<form method="post">
  <div class="form-group mt-3">
      ...
      <input class="form-control" type="text" name="IDmatkul" placeholder="ID Mata Kuliah" id="idMatkul" value="<?= $mk->getIdMataKuliah() ;?>" required>
  </div>
  <div class="form-group">
      <label for="namaMatkul" class="form-label">Nama Matakuliah</label>
      <input class="form-control" type="text" name="namaMatkul" placeholder="Nama Mata Kuliah" id="namaMatkul" value="<?= $mk->getNamaMataKuliah() ;?>" required>
  </div>
  <div class="form-group">
      <label for="sks" class="form-label">Sks</label>
      <input class="form-control" type="text" name="sks" placeholder="Jumlah SKS" id="sks" value="<?= $mk->getSKS() ;?>" required>
  </div>
  <div class="form-group">
